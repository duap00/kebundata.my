  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <header className="max-w-7xl mx-auto px-6 md:px-12 py-8">
        <div className="flex items-center justify-between">
          ...
          <nav className="space-x-4">
            ...
            <Link to="/hardware" className="text-sm font-bold text-slate-600">Hardware</Link>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        <h1 className="text-4xl font-black mb-6">Integrated Software Ecosystem</h1>
        <p className="text-slate-600 max-w-2xl">Connecting Odoo 18 with real-time sensor data for full farm transparency. Our software stack provides monitoring, alerts, and invoicing integrations for modern vertical farms.</p>
      </main>
    </div>
  );
};
